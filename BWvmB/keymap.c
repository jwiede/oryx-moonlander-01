...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LEFT_CTRL,   KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           MEH_T(KC_BSPC),                                                                 ALL_T(KC_DELETE),KC_H,           KC_J,           KC_K,           KC_L,           LT(2, KC_SCLN), MT(MOD_RCTL, KC_QUOTE),
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         MT(MOD_RCTL, KC_SLASH),KC_RIGHT_SHIFT, 
    LT(1, KC_GRAVE),CW_TOGG,        KC_TRANSPARENT, KC_UP,          KC_DOWN,        MT(MOD_LALT, KC_APPLICATION),                                                                                                MT(MOD_RGUI, KC_ESCAPE),KC_LEFT,        KC_RIGHT,       KC_LBRC,        KC_RBRC,        MO(1),          
