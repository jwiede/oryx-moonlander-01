...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_PAGE_UP,                                     KC_PGDN,        KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,       
    KC_DELETE,      KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           TG(1),                                          TG(2),          KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLS,        
    KC_LEFT_CTRL,   KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           MEH_T(KC_BSPC),                                                                 ALL_T(KC_DELETE),KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        MT(MOD_RCTL, KC_QUOTE),
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RIGHT_SHIFT, 
    LT(1, KC_GRAVE),CW_TOGG,        KC_TRANSPARENT, KC_UP,          KC_DOWN,        MT(MOD_LALT, KC_APPLICATION),                                                                                                MT(MOD_RGUI, KC_ESCAPE),KC_LEFT,        KC_RIGHT,       KC_LBRC,        KC_RBRC,        MO(2),          
    KC_SPACE,       KC_TAB,         MT(MOD_LGUI, KC_ENTER),                MT(MOD_RALT, KC_SPACE),KC_ENTER,       KC_BSPC
  ),
  [1] = LAYOUT_moonlander(
